...
export function renderBus8(studenticonvittori) {

    if (!Array.isArray(studenticonvittori)) {
        console.error("Lista convittori non valida");
        return;
    }
    ...
    listaFinale.forEach((s, index) => {
        ...
        row.innerHTML = `
            ...
            <div class="cell-check">
                <div class="check-box" style="cursor:pointer"></div>
            </div>
